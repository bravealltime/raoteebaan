        ...
        <ModalContent borderRadius="2xl" p={2}>
          <div className="invoice-print-area">
            ...
            <ModalBody>
              ...
              <Button className="no-print" leftIcon={<FaDownload />} colorScheme="blue" mt={6} w="full" borderRadius="xl" fontFamily="Kanit" fontWeight="bold" size="md" onClick={handlePrint}>
